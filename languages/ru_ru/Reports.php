...
$languageStrings = array(
	...
	'Account and Contact Reports'  => 'Отчеты по Физ. лицам и Юр. лицам',
	...
	'Contacts by Accounts'         => 'Физ. лица по Юр. лицам',
	'Contacts without Accounts'    => 'Физ. лица без Юр. лиц',
	'Contacts by Potentials'       => 'Физ. лица по Сделкам',
	'Contacts related to Accounts' => 'Физ. лица, относящиеся к Юр. лицам',
	'Contacts not related to Accounts' => 'Физ. лица, не относящиеся к Юр. лицам',
	'Contacts related to Potentials' => 'Физ. лица относящиеся к Сделкам',
	...
	'Products by Contacts'         => 'Товары по Физ. лицам',
	'Product Detailed Report'      => 'Детальный отчет по Товарам', 
	'Products related to Contacts' => 'Товары относящиеся к Физ. лицам',
	'Open Quotes'                  => 'Открытые Предложения', 
	'Quotes Detailed Report'       => 'Детальный Отчет Запросов', 
	'Quotes that are Open'         => 'Открытые Запросы', 
    // SalesPlatform.ru begin New localization
	'PurchaseOrder by Contacts'    => 'Закупки по Физ. лицам',
	'PurchaseOrder Detailed Report' => 'Детальный отчет по Закупкам', 
	'PurchaseOrder related to Contacts' => 'Закупки, относящиеся к Физ. лицам',
    //'PurchaseOrder by Contacts'    => 'Заказы на Закупку по Физ. лицам',
	//'PurchaseOrder Detailed Report' => 'Детальный отчет по Заказам на Закупку', 
	//'PurchaseOrder related to Contacts' => 'Заказы на Закупку, относящиеся к Физ. лицам',
    // SalesPlatform.ru end
    ...
    'Contacts Email Report'        => 'Отчет по письмам Физ. лиц',
	'Accounts Email Report'        => 'Отчет по письмам Юр. лиц',
	'Leads Email Report'           => 'Отчет по письмам Обращений',
	'Vendors Email Report'         => 'Отчет по письмам Поставщиков',
	'Emails sent to Contacts'      => 'Письма, отправленные Физ. лицам',
	'Emails sent to Organizations' => 'Письма, отправленные Юр. лицам',
