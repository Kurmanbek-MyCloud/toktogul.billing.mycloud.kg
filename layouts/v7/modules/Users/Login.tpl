...
{strip}
	<style>
        ...
        <div class="linksNavBar">
            <div class="helpLinks">
				<a target="_blank" href="https://crm.kg/blog/">Блог</a>
				<a target="_blank" href="https://crm.kg/about-us/">О нас</a>
				<a target="_blank" href="https://crm.kg">CRM Technologies</a>
				<a target="_blank" href="https://crm.kg/our-products/oimo-billing-zhkh">Oimo Billing</a>
	...
	<div class="col-lg-12">
		...
		{*SalesPlatform.ru begin*}
				<img class="img-responsive user-logo" src="test/logo/oimo_billing_logo.png">
                {*
