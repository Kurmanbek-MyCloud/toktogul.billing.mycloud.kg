...
Vtiger.Class("Settings_Vtiger_CompanyDetails_Js",{},{
	...
	registerUpdateDetailsClickEvent : function() {
		jQuery('#updateCompanyDetails').on('click',function(e){
            ...
            window.location.href = "index.php?parent=Settings&module=Vtiger&view=CompanyDetailsEdit&company=" + 
                encodeURIComponent($("#currentCompany").val());
    ...
    registerCreateCompany : function() {
        $("#createCompany").on("click", function() {
            window.location.href = "index.php?parent=Settings&module=Vtiger&view=CompanyDetailsEdit";
        });  
    },
    
    registerChangeCompanyLegalOpinion : function() {
        $("#currentCompany").on("change", function() {
            app.helper.showProgress();
            var opinionName = $(this).val();
            window.location.href = "index.php?parent=Settings&module=Vtiger&view=CompanyDetails&company=" + encodeURIComponent(opinionName);
        })
    },
    
    registerDeleteCompany : function() {
        $('#deleteCompany').on('click',function(e) {
            app.helper.showConfirmationBox({message : app.vtranslate('JS_LBL_CONFIRM_DELETE_COMPANY')}).then(
                function(e) {
                    app.helper.showProgress();
                    AppConnector.request({
                        ...
                        function(response) {
                            window.location.href = "index.php?parent=Settings&module=Vtiger&view=CompanyDetails";
                        },
	...
	registerEvents: function() {
        ...
        this.registerChangeCompanyLegalOpinion();
        this.registerDeleteCompany();
        //SalesPlatform.ru end
	}
