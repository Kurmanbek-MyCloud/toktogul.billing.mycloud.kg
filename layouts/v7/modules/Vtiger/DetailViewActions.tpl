    ...
    <div class="col-lg-6 detailViewButtoncontainer">
        <div class="pull-right btn-toolbar">
            ...
            {if $MODULE_MODEL->isStarredEnabled()}
                ...
                <button class="btn btn-default markStar hide {if $STARRED} active {/if}" id="starToggle" style="width:140px;">
            ...
            {* {if $MODULE_NAME eq 'SPPayments'}
                <button class="btn btn-default" id="{$MODULE_NAME}_detailView_basicAction_print" onclick="window.location.href = 'phpword/index.php?type=pko&recordid={$RECORD->getId()}'">
                    Скачать ПКО
                </button>    
            {/if} *}
