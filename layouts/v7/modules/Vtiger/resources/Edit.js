...
Vtiger_Index_Js("Vtiger_Edit_Js",{
    ...
    */
    ...
    onChangeEvents : function() {
        let module_name = app.getModuleName();
        if (module_name == 'Meters'){
            $('#Meters_editView_fieldName_meter').on('keyup', ()=>{
                let first_cchar =$('#Meters_editView_fieldName_meter').val()[0]
                if (first_cchar == 0 ){
                    $('#Meters_editView_fieldName_meter').val('')
                }
            });
            let meter = $('#Meters_editView_fieldName_meter').val()
            if (meter != ''){
                $('#Meters_editView_fieldName_meter').parent().hide().prev().hide()
            }
        }
	},
