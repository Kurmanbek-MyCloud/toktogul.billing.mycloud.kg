...
<html ng-app="mobileapp">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="../../{$TEMPLATE_WEBPATH}/dist/css/app.css">
		<link type="text/css" rel="stylesheet" href="../../{$TEMPLATE_WEBPATH}/resources/fonts/dripicons/fonts.css">
		<link type="text/css" rel="stylesheet" href="../../{$TEMPLATE_WEBPATH}/resources/fonts/md-icons/css/materialdesignicons.min.css">
