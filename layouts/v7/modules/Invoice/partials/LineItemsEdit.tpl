			...
			<div class="lineitemTableContainer">
				...
				<table class="table table-bordered lineItemTable" id="lineItemTab">
					...
					<tr>
						...
						<td><strong>База для начисления</strong></td>

						<td><strong>Предыдущее показание</strong></td>

						<td><strong>Текущее показание</strong></td>
						...
						<td class="hidden"><strong class="pull-right">{vtranslate('LBL_NET_PRICE',$MODULE)}</strong></td>
