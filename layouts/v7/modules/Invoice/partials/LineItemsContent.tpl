...
{strip}
	...
	<td>
		<input id="{$accrualBase}" name="{$accrualBase}" type="text" class="smallInputBox inputElement"
			   value="{$data.$accrualBase}">
	</td>
	...
	<td>
		<input id="{$qty}" name="{$qty}" type="text" class="qty smallInputBox inputElement"
			   data-rule-required=true data-rule-positive=true data-rule-greater_than_zero=true value="{if !empty($data.$qty)}{$data.$qty}{else}2{/if}"
