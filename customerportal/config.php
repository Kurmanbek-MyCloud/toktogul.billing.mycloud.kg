...
class Portal_Config_Data {
	...
	protected static $data = array(
		...
		'crm.url' => 'https://ideal-home.oimo-billing.mycloud.kg/',

		//Portal URL without trialing/
		//Example: http://yourdomain.com/portal
		'portal.url' => 'https://ideal-home.oimo-billing.mycloud.kg/customerportal',
	...
	protected static function getData() {
        ...
        self::$data['ui.Language'] = array('label' => 'RU Russian', 'value' => 'ru_ru');
        //SalesPlatform.ru end
		...
		self::$data['languages'] = array(
            //SalesPlatform.ru begin
            array('label' => 'RU Russian', 'value' => 'ru_ru'),
            //SalesPlatform.ru end
