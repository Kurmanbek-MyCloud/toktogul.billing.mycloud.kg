<?php /* Smarty version Smarty-3.1.19, created on 2019-06-24 02:57:39
         compiled from "/var/www/html/vtiger/customerportal/layouts/default/templates/Header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8000887125c63cd54c20cf0-30552019%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6adcb7425d452a39c02623f3a3aee648c4377f40' => 
    array (
      0 => '/var/www/html/vtiger/customerportal/layouts/default/templates/Header.tpl',
      1 => 1556183706,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8000887125c63cd54c20cf0-30552019',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5c63cd54c493e3_13554936',
  'variables' => 
  array (
    'MODULE' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5c63cd54c493e3_13554936')) {function content_5c63cd54c493e3_13554936($_smarty_tpl) {?>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<!--<span class="text-danger" ng-if="data.oldPassword.length && data.newPassword.length && data.confirmPassword.length && (data.newPassword!==data.confirmPassword) && (data.newPassword!==data.oldPassword)">Re-confirm your password</span>-->
                                                                    <span class="text-danger" ng-if="data.oldPassword.length && data.newPassword.length && data.confirmPassword.length && (data.newPassword!==data.confirmPassword) && (data.newPassword!==data.oldPassword)" translate="Re-confirm your password">Re-confirm your password</span>
