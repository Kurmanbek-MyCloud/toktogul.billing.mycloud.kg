...
class Announcements extends Vtiger_CRMEntity {
	...
	var $list_fields = Array (
		...
		'Announcement' => Array('announcements', 'announcement'),
	...
	var $list_link_field = 'announcement';
	...
	var $popup_fields = Array ('announcement');

	// For Alphabetical search
	var $def_basicsearch_col = 'announcement';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'announcement';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('announcement','assigned_user_id');

	var $default_order_by = 'announcement';
