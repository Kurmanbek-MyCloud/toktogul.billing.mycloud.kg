...
class CustomerPortal_FetchModules extends CustomerPortal_API_Abstract {
	...
	function process(CustomerPortal_API_Request $request) {
		...
		if ($current_user) {
			...
			$sql = <<<EOD
SELECT vtiger_relatedlists.label, vtiger_customerportal_tabs.tabid, 
vtiger_customerportal_tabs.sequence, vtiger_customerportal_tabs.createrecord, 
vtiger_customerportal_tabs.editrecord, vtiger_customerportal_fields.records_visible 
